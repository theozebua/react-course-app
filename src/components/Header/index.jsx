        ...
        <div className='flex flex-col gap-4 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col gap-2 md:w-1/2'>
            ...
            <div className='mt-2 flex items-center justify-center gap-4 md:justify-start'>
              <button className='rounded-xl border border-primary bg-primary px-4 py-2 tracking-wide text-white'>Get Started</button>
              <button className='rounded-xl border-2 border-primary px-4 py-2 tracking-wide text-primary'>Learn More</button>
            </div>
          </div>
        </div>
      </div>
